	...
	while key != "Escape":
		...
		if key == "Return":
			while key != 'Escape':
				...
				win.plot(mars.getCenter().getX(), mars.getCenter().getY(), 'white')

				new_neptune_x, new_neptune_y = mars.getCenter().getX() + neptune_orbit_radius * math.cos(2*t), mars.getCenter().getY() + neptune_orbit_radius * math.sin(2*t)
				center = neptune.getCenter()
				print(center)
				neptune.move(new_neptune_x - center.getX(), new_neptune_y - center.getY())
				neptune.name.move(new_neptune_x - center.getX(), new_neptune_y - center.getY())
				win.plot(neptune.getCenter().getX(), neptune.getCenter().getY(), 'yellow')
